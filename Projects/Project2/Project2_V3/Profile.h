...
class Profile
{
    ...
    public:
        ...
        short getScr();//returns hscore
        long getLctn();//returns location of profile in file
        void setScr(short);//changes hscore to specified value
...
short Profile::getScr()
{
    return hscore;
}
long Profile::getLctn()
{
    return fLctn;
}
void Profile::setScr(short s)
{
    hscore=s;
}
